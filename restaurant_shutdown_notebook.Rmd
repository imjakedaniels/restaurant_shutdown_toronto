...
```{r, fig.height = 675, fig.width = 1200, units = "px"}
p <- open_table_canadian %>%
  ...
  theme(text = element_text(colour = "#15202b", family = "Montserrat ExtraBold"),
        plot.title = element_text(size = 22, family = "Merriweather Black", hjust = 0.5),
...
options(gganimate.dev_args = list(height = 675, width = 1200, units = 'in', type = "cairo", res = 320))
